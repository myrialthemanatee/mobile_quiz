...
import com.example.tietovisa_marialintunen.databinding.FragmentSixthBinding
...
class SixthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSixth.setOnClickListener {
            ...
            answers += view.findViewById<RadioButton>(view.findViewById<RadioGroup>(R.id.vastaukset5).checkedRadioButtonId).text;
            answers += '\n'
